        ...
        <div className="navbar bg-base-100 p-0">
          ...
          <div className="navbar-center">
            <ul className="menu menu-horizontal p-0">
              <li className="text-sm"><Link href="/" className="p-3">Home</Link></li>
              <li className="text-sm"><Link href="/addclothing" className="p-3">Add Clothing</Link></li>
              <li className="text-sm"><Link href="/wardrobe" className="p-3">Wardrobe</Link></li>
              <li className="text-sm"><Link href="/storage" className="p-3">Storage</Link></li>
            </ul>
          </div>
          ...
          <div className='navbar-end pr-8'>
            <div className="dropdown dropdown-end" style={{ position: 'relative' }}>
              <div onClick={toggleDropdown} role="button" className="btn btn-ghost btn-circle avatar">
              ...
              {dropdownOpen && (
                <ul className="shadow menu menu-sm bg-base-100 rounded-box" style={{ position: 'absolute', top: '115%', right: -25, zIndex: 50 }}>
                  <li><Link href="/settings" className="justify-center">Settings</Link></li>
                  <li><Link href="/api/auth/logout" className="justify-center">Logout</Link></li>
                </ul>
              )}
            </div>
          </div>
